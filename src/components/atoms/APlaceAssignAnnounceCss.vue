...
.post_content .content-wrapper a {
    color: #0366d6;
    text-decoration: none;
    transition: 0.5s;
}

.post_content .content-wrapper a:hover {
    transition: 0.5s;
    opacity: 0.8;
}

body .news_detail_sec .post_content {
    font-family: 'dnp-shuei-gothic-gin-std', serif !important;
    font-weight: 400;
...
.news_detail_sec h6,
.news_detail_sec em {
    font-family: 'kinuta-maruminfuji-stdn', serif !important;
    line-height: 2;
    font-weight: 500;
}
...
details summary[data-v-2b304856]::after {
    position: absolute;
    top: 50%;
    right: 30px;
...
.password_string {
    ...
    bottom: 0;
    right: 0;
    padding-left: 30px; /*position: absolute;でのmarginは親要素はみ出す*/
    font-size: 1.2rem;
