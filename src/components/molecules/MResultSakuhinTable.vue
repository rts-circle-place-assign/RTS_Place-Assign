...
const tenCircle = notDigiAna.filter(circle => circle.mediacode === 10)
const notAdult = tenCircle.filter(circle => !isAdult(circle.seijin))
const adult = tenCircle.filter(circle => isAdult(circle.seijin))
