...
const pages = [
  ...
  },
  {
    ...
    link: 'joint-adult-different',
  },
  {
    title: 'なかよしコード・合体矛盾処理（メディアコード編）',
    link: 'joint-media-different',
  },
  {
    title: 'なかよしコード・合体矛盾処理（作品コード編）',
    link: 'joint-sakuhin-different',
  },
  {
    title: 'コスプレメディアコード修正',
    link: 'cosplay-correct',
  },
  {
    title: '作品コード・キャラ矛盾処理',
    link: 'sakuhin-media-different',
  },
  {
    title: 'グッズ矛盾処理',
